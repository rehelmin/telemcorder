...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOD, NGYRO_CS_Pin|NACCEL_CS_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : GPIO10_Pin A4_Pin A3_Pin */
  GPIO_InitStruct.Pin = GPIO10_Pin|A4_Pin|A3_Pin;
  ...
  /*Configure GPIO pin : NBMP_CS_Pin */
  GPIO_InitStruct.Pin = NBMP_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_OD;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
